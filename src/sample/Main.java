...
//        Circle myCircle = new Circle(new Point(100,100), 30);
        ...
        button.setOnMouseClicked(e -> myTriangle.renderTriangle(root));
        button2.setOnMouseClicked(e -> myTriangle.rotate());
        button.setLayoutX(200);button.setLayoutY(200);
        button2.setLayoutX(300);button2.setLayoutY(100);
        root.getChildren().addAll(myTriangle.triangleRoot.getChildren());
