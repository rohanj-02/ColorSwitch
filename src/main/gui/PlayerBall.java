...
//		System.out.println(" Ball Pos Y" + this.getPosY());
		this.pausePosition = new Point(this.ballSVG.getTranslateX() + this.ballSVG.getLayoutX() + this.getPosX() , this.ballSVG.getTranslateY() + this.ballSVG.getLayoutY() + this.getPosY());
//		System.out.println("Pause position" + this.pausePosition);
	...
	public void play(double collisionY) {
		this.ballSVG.setTranslateY(collisionY - PLAYER_START_Y);
...
//		this.ballRoot = new Circle(this.getPosX(), this.getPosY(), radius);
	...
	public void render(Group gameRoot) {
		if(!gameRoot.getChildren().contains(this.ballSVG)){
